...
$$
token_id = nucleus_indices[sampled_index] return token_id #### 3.4.2 Example với Different P Values **Distribution:** Rank | Token    | Probability | Cumulative -----|----------|-------------|------------ 1    | coffee   | 0.340       | 0.340 2    | tea      | 0.285       | 0.625 3    | cereal   | 0.195       | 0.820 4    | smoothie | 0.085       | 0.905 5    | mouth    | 0.045       | 0.950 6    | pocket   | 0.040       | 0.990
$$
...
$$
Cumulative ≥ 0.50 at token 2 (tea) Nucleus: {coffee, tea} Size: 2 tokens → Sample from 2 tokens #### 3.4.3 Adaptive Behavior **Key advantage: Nucleus size adapts to distribution shape** **Scenario 1: High confidence (peaked distribution)** Token     | Prob  | Cumulative ----------|-------|------------ the       | 0.92  | 0.92 a         | 0.03  | 0.95 ...
$$
...
$$
→ Acts like greedy! ✓ Reason: Model is confident, should be deterministic **Scenario 2: Low confidence (flat distribution)** Token     | Prob  | Cumulative ----------|-------|------------ coffee    | 0.11  | 0.11 tea       | 0.10  | 0.21 cereal    | 0.10  | 0.31 smoothie  | 0.09  | 0.40 ... (continuing to ~10th token to reach 0.9)
$$
...
$$
K = 1      | Equivalent to greedy K = 5-10   | Conservative exploration K = 40-50  | Moderate diversity K = 100+   | Approaching multinomial
$$
...
$$
P = 0.5    | Very conservative P = 0.9    | Standard (recommended) P = 0.95   | More exploratory P = 0.99   | Very exploratory P = 1.0    | Multinomial
$$
