...
$$
ax1.set_xlabel('Index') ax1.set_ylabel('Probability') ax1.set_title('Expected vs Observed Frequencies') ax1.legend()
$$
...
$$
ax.set_xlabel('Index') ax.set_ylabel('Sampling Frequency') ax.set_title('Effect of Softmax on Sampling Distribution') ax.legend()
$$

ax.grid(True, alpha=0.3)

$$
# Add weights as text for i, w in enumerate(weights):
$$

ax.text(i, -0.05, f'w={w:.1f}', ha='center', fontsize=9)

$$
plt.tight_layout() return fig # Example usage
$$
