...
Để đảm bảo kết quả T-test ở Phần 1 không bị chi phối bởi duy nhất một từ đích (ví dụ: một nơ-ron chỉ "thích" từ "toothpaste"), chúng ta cô lập các nơ-ron có giá trị $\mid T\mid$ cực đại tại tầng 16 và trực quan hóa toàn bộ 40 điểm hoạt hóa.
