...
- **Hàm tổn thất (Loss):** $L = -a + \lambda \\mid \theta\\mid_2^2$. Việc lấy dấu trừ biến bài toán thành cực tiểu hóa, phù hợp với hầu hết các bộ tối ưu (optimizers). Thành phần L2 được thêm vào để ngăn chặn hiện tượng bùng nổ trọng số.
