...
- **Đồng nhất hóa văn hóa (Cultural homogenization):** Sự bão hòa các tác phẩm ngôn ngữ và nghệ thuật trượt về một vector trung bình (ave18_rage vector), đánh mất đi sự sáng tạo nguyên bản của loài người.
