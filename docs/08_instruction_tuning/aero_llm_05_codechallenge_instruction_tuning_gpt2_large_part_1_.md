...
$$
Kết quả quan sát thực nghiệm cho thấy: \mathbb{E}[A_i] \gg \mathbb{E}[Q_i] Điều này dẫn đến mất cân bằng trong gradient khi tối ưu hóa. ⸻ 4. Hàm mất mát và tối ưu hóa Mục tiêu huấn luyện là tối thiểu hóa cross-entropy:
$$
...
$$
Trong đó rx là reward model đánh giá chất lượng câu trả lời. ⸻ 7. Các cân nhắc thực tiễn khi huấn luyện GPT-2 Large 7.1. Bộ nhớ và batch size Với 1.5B tham số:
$$
...
$$
7.2. Learning rate Thông thường: \eta \in [10^{-5}, 10^{-4}] Với warmup:
$$
