...
# 📂 Module: 18_rag
> **Tài liệu chuyên sâu và bài tập thuộc phần 18_rag.**
...
| Thư mục | Liên kết |
| :--- | :--- |
| **advanced rag with vector databases and retrievers** | [Mở thư mục →](advanced_rag_with_vector_databases_and_retrievers/index.md) |
