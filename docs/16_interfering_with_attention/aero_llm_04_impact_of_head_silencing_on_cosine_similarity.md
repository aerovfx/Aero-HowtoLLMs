...
- **Chỉ số:** Độ tương đồng Cosine giữa tất cả các cặp token trong câu: $CS(\mathbf{v}_i, \mathbf{v}_j) = \frac{\mathbf{v}_i \cdot \mathbf{v}_j}{\\mid \mathbf{v}_i\| \|\mathbf{v}_j\|}$.
