...
export function dimStyleColor(style: DimStyle) {
    switch (style) {
        case DimStyle.t:
        case DimStyle.T:
            return Vec4.fromHexColor('#3F4E4F'); // Lunar Eclipse
        case DimStyle.A:
            return Vec4.fromHexColor('#A27B5B'); // Creme Brulee
        case DimStyle.C:
        case DimStyle.C4:
            return Vec4.fromHexColor('#A27B5B'); // Creme Brulee
        case DimStyle.Token:
            return Vec4.fromHexColor('#DCD7C9'); // Au Lait
        case DimStyle.TokenIdx:
            return Vec4.fromHexColor('#2C3639'); // Inkwell
...
export const Colors = {
    Weights: Vec4.fromHexColor('#A27B5B'), // Creme Brulee
    Intermediates: Vec4.fromHexColor('#DCD7C9'), // Au Lait
    Aggregates: Vec4.fromHexColor('#3F4E4F'), // Lunar Eclipse
    Highlight: Vec4.fromHexColor('#DCD7C9'), // Au Lait
