...
import { walkthrough10_MicroGPT } from "./Walkthrough10_MicroGPT";
...
export function initWalkthrough() {
    return {
        ...
        phaseList: [{
            ...
            title: 'Giới thiệu',
            phases: [
                { id: Phase.Intro_Intro, title: 'Tổng quan' },
                { id: Phase.Intro_Prelim, title: 'Sơ lược' },
            ],
        }, {
            ...
            phases: [
                ...
                { id: Phase.Input_Detail_Projection, title: 'Phép chiếu (Projection)' },
                ...
                { id: Phase.Input_Detail_Output, title: 'Đầu ra (Output)' },
            ],
        }, {
            groupId: PhaseGroup.MicroGPT,
            title: 'MicroGPT',
            phases: [
                { id: Phase.MicroGPT_Intro, title: 'Giới thiệu MicroGPT' },
            ],
        }] as IPhaseGroup[],
    };
}
...
export function runWalkthrough(state: IProgramState, view: IRenderView) {
    ...
    } else if (groupId === PhaseGroup.MicroGPT) {
        walkthrough10_MicroGPT(wtArgs);
    }
