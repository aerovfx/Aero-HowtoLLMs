...
export const WalkthroughSidebar: React.FC = () => {
    ...
    function toggleDetail() {
        progState.detailLevel = progState.detailLevel === 2 ? 1 : 2;
        progState.markDirty();
    }
    ...
    return <div className={s.walkthrough}>
        <div className={s.split}>
            ...
            <div className={s.content}>
                <div className={s.menuTopBar} style={{ marginBottom: '10px' }}>
                    <div className={s.menu} onClick={() => toggleDetail()} style={{ cursor: 'pointer', padding: '5px', background: '#eee', borderRadius: '4px' }}>
                        Chế độ: {progState.detailLevel === 2 ? 'Chi tiết' : 'Tổng quan'}
                    </div>
