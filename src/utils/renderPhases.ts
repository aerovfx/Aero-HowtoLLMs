...
export interface IBufferTex {
    ...
    shape?: number[]; // Logical shape of the tensor stored in this texture
}
...
export function createBufferTex(gl: WebGL2RenderingContext, width: number, height: number, channels: number, shape?: number[]): IBufferTex {
