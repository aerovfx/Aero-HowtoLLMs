...
export interface IGptModelConfig {
    ...
    vocab_size: number;
    block_size: number;
    n_images?: number; // Number of images to process
...
export interface ITransformerLayerConfig extends ILayerConfig {
    type: LayerType.TransformerBlock;
}

export interface IMoELayerConfig extends ILayerConfig {
    type: LayerType.MoE;
    n_experts: number;
